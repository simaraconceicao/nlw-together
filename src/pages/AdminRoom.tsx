                        ...
                        >
                            {!question.isAnswered && (
                                <>
                                    <button
                                        type = "button"
                                        onClick={() => handleCheckQuestionAnswared(question.id)}
                                    >
                                        <img src={checkImg} alt="Botão para marcar pergunta como respondida"/>
                                    </button>
                                    <button
                                        type = "button"
                                        onClick={() => handleHighlighQuestion(question.id)}
                                    >
                                        <img src={answerImg} alt="Botão para dar destaque à pergunta"/>
                                    </button>
                                </>
                            ) } 
                            <button
